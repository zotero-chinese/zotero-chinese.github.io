---
url: /user-guidems-word-plugin.md
---
...
若要禁用引文中引文的自动排序，请拖动引文以在「添加引文」框中重新排列引文。您也可以单击「添加引文」框右下角的「引用设置」图标，然后取消选中「保持文献自动排序」选项。*此选项仅对指定引文排序顺序的引文样式显示。* 要恢复自动排序，请重新选中「保持源已排序」选项。
