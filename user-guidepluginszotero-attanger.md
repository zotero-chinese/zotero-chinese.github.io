---
url: /user-guidepluginszotero-attanger.md
---
...
* [国内镜像](/plugins/#search=Zotero+Attanger)
...
| 匹配 Attanger 附件 | 仅用作特殊用途                                            | 相比于「匹配附件」，本功能的匹配规则更加严格，具体请阅读表格下方的详细功能说明。                                                                                                                                                | 源路径、靶路径、重命名规则、重命名/移动的附件类型、已链接附件的根目录 |
| 附加新文件         | 为条目补充附件                                            | 将源路径中最新的文件添加到 Zotero 中。相比于「匹配附件」，本功能既不会检查文件名和标题是否匹配，也不检查附件的类型，而是直接将「源路径」目录下（不包括子目录）最新的文件添加到 Zotero 中作为该条目的附件。                      | 源路径                                                                |
...
:::: details 关于「匹配 Attanger 附件」的功能说明
...
#### J1.2.1 Zotero Attanger 插件的「源路径」设置
...
#### J1.2.2 Zotero Attanger 插件的「靶路径」设置
...
#### J1.2.3 Zotero 高级设置中的「已链接附件的根目录」设置
