---
url: /user-guidefaqsupdate-translators.md
---
...
2. 进入茉莉花插件的设置，转到「中文转换器设置」部分，然后点击「立即更新」按钮。这一按钮点一下即可，请不要快速连续点多次，以免出现意外错误。
   ...
   升级 Zotero 7 正式版的步骤和常见问题的解答请阅读：[你好，Zotero 7](/blog/posts/hello-zotero-7)。
...
* [Mozilla Firefox（国际官网）](https://www.mozilla.org/zh-CN/firefox/new/)
...
* 对于中文文献，建议访问「[Zotero 中文转换器](/translators/)」，查看支持的网站列表，选择其他网站进行搜索和抓取。特别注意，对于图书专著，需核实 Zotero 抓取的信息是否完整准确。
