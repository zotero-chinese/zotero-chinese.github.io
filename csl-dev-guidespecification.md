---
url: /csl-dev-guidespecification.md
---
...
* 链接：链接是指向 URL 的东西，例如你点击本站左上角挂着中国结的[「Z」图标](/logo.png) 时，你就能跳转到 Zotero 中文小组的 [主页](https://zotero-chinese.com)（网址的主页也是以互联网资源的形式呈现的），此时这个图标就是联系你和主页的「链接」。
...
方法 1 还可以出于全局 *姓名消歧* 的目的来使用，把整个文档中混淆的和未混淆的引注都进行转换。
...
* philosophy 哲学
* physics 物理学
* political\_science 政治科学
* psychology 心理学
* science 科学
* social\_science 社会科学
* sociology 社会学
* theology 神学
* zoology 动物学
