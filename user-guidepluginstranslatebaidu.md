---
url: /user-guidepluginstranslatebaidu.md
---
...
直接访问 <https://fanyi-api.baidu.com/product/11>，如果未登录，点击右上角登录。没百度账号的同学，就直接新注册一个。
...
访问 <https://fanyi-api.baidu.com/product/11>，直接点击下方立即使用：
...
访问 <https://fanyi-api.baidu.com/choose> ，选择通用文本翻译，点下一步：
...
打开这个网页 <https://fanyi-api.baidu.com/choose>，选择领域翻译，点下一步：
...
<https://fanyi-api.baidu.com/api/trans/product/desktop?req=field> 垂直领域的后台界面，上面有对应的使用明细。

## 4. 接口密钥查询

打开 <https://fanyi-api.baidu.com/api/trans/product/desktop>，可以在最下面看到配置使用的 APP ID 和密钥。
