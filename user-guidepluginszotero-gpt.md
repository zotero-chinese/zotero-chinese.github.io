---
url: /user-guidepluginszotero-gpt.md
---
...
| 退出               | `ESC`                                                                                                                                                                |
| 多行编辑           | `Shift` + `Enter`                                                                                                                                                    |
| 放大/缩小/调整字号 | ![放大缩小](../../assets/images/zotero-plugin-gpt/zoterogpt-放大做小.png)在 回复区 按下`ctrl+滚轮`调整可以调整字体大小在 指令区 按下 `ctrl+滚轮`调整命令框大小 |
