---
url: /user-guidepluginsabout-plugin.md
---
...
* Zotero 中文社区插件商店：[https://zotero-chinese.com/plugins/](/plugins/)
...
Zotero 6（上一版本）和 Zotero 7（最新版本）的插件互不兼容，请在下载插件安装包时下载与你 Zotero 版本适配的版本。[中文插件商店](/plugins/) 中有注明兼容的目标 Zotero 版本，下载时请务必注意。
