---
url: /user-guidefaqsword-addon.md
---
...
一些论文的题目中包含上标、下标或者斜体：如 CO2，H+，这该如何实现呢？
...
插件 [Linter for Zotero](../plugins/linter.md) 提供了辅助输入这些富文本标签的功能，可前往 [插件商店](/plugins/)下载安装。
...
插件 [Linter for Zotero](../plugins/linter.md) 提供了自动识别条目语言并设定语言字段的功能，可前往 [插件商店](/plugins/)下载安装。
