...
针对这一问题，您可以下载并安装 [Del Item With Attachment 插件](/plugins/#search=Del+Item+With+Attachment)，然后在文库中选中需要删除的条目（或条目中的附件），右键点击，选择「删除附件」→「删除条目和附件」，即可删除 Zotero 中的链接和系统中的文件。
